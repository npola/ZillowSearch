...
SWIFT_CLASS("_TtC9Homework911AppDelegate")
...
SWIFT_CLASS("_TtC9Homework99BasicInfo")
@interface BasicInfo : UIViewController <UITableViewDelegate, UITableViewDataSource>
...
SWIFT_CLASS("_TtC9Homework913HTTPOperation")
...
SWIFT_CLASS("_TtC9Homework921HTTPRequestSerializer")
...
SWIFT_CLASS("_TtC9Homework98HTTPTask")
...
SWIFT_CLASS("_TtC9Homework910HTTPUpload")
...
SWIFT_CLASS("_TtC9Homework920HistoricalZestimates")
...
SWIFT_CLASS("_TtC9Homework97JLToast")
@interface JLToast : NSOperation
@property (nonatomic) JLToastView * view;
@property (nonatomic, copy) NSString * text;
@property (nonatomic) NSTimeInterval delay;
@property (nonatomic) NSTimeInterval duration;
@property (nonatomic, getter=isExecuting, setter=setExecuting:) BOOL executing;
@property (nonatomic, getter=isFinished, setter=setFinished:) BOOL finished;
+ (JLToast *)makeText:(NSString *)text;
+ (JLToast *)makeText:(NSString *)text duration:(NSTimeInterval)duration;
+ (JLToast *)makeText:(NSString *)text delay:(NSTimeInterval)delay duration:(NSTimeInterval)duration;
- (void)show;
- (void)start;
- (void)main;
- (void)finish;
...
SWIFT_CLASS("_TtC9Homework913JLToastCenter")
...
SWIFT_CLASS("_TtC9Homework911JLToastView")
...
SWIFT_CLASS("_TtC9Homework921JSONRequestSerializer")
@interface JSONRequestSerializer : HTTPRequestSerializer
- (instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC9Homework912MyCustomCell")
...
SWIFT_CLASS("_TtC9Homework913MyCustomCell2")
...
SWIFT_CLASS("_TtC9Homework913MyCustomCell3")
...
SWIFT_CLASS("_TtC9Homework913TabController")
...
SWIFT_CLASS("_TtC9Homework914ViewController")
